...
public class RegisterView {
    ...
    public VBox getView() {
        ...
        usernameField.setStyle("-fx-pref-width: 300px; -fx-padding: 10px; -fx-background-color: #f0f0f0;");

        PasswordField passwordField = new PasswordField();
        passwordField.setPromptText("🔒 Password");
        passwordField.setStyle("-fx-pref-width: 300px; -fx-padding: 10px; -fx-background-color: #f0f0f0;");
        ...
        roleComboBox.setStyle("-fx-pref-width: 300px; -fx-padding: 10px; -fx-background-color: #f0f0f0;");
        
        Button registerButton = new Button("✔️ Register");
        registerButton.setStyle("-fx-background-color: #4CAF50; -fx-text-fill: white; -fx-padding: 10px 20px; -fx-font-weight: bold;");
        ...
        registerButton.setOnAction(e -> {
            ...
            try {
                ...
                showError("⚠️ Koneksi database gagal! 🛑");
                return;
            }
